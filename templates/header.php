...
<!-- header -->
	...
	<div class="bingkai">
		...
		<a href="KALURFC.COM"><h3 class="hatiga">KALURFC</h3></a>
	...
	<div class="header">
		<div class="container">
			...
			<div class="w3l_logo">
				<a href="index.php"><img src="assets/frontend/images/store.png" height="65px" width="190px" alt=""></a>
			</div>
			<div class="search">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="w3ls_products_pos">
											<h4>50%<i>Off/-</i></h4>
											<img src="assets/frontend/images/kj1.jpg" alt=" " class="img-responsive" />
										</div>
									</div>
									<div class="clearfix"></div>
								</div>
